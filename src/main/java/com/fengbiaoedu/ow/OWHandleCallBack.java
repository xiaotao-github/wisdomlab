...
import cc.wulian.ihome.wan.entity.*;
 ...
 */
public class OWHandleCallBack implements MessageCallback {
	
	private static OWHandleCallBack owHandleCallBack = new OWHandleCallBack();
	
	
	private OWHandleCallBack(){
		
	}
	public static OWHandleCallBack instance(){
		return owHandleCallBack;
	}
...
/*	private void checkGatewayResult(int result) {
	...
	public void DeviceUp(DeviceInfo devInfo, Set<DeviceEPInfo> devEPInfoSet,
		...
		OWDeviceManager.getInstance().owAddDevice(devInfo,devEPInfoSet);
	}
	...
	public void offlineDevicesBack(DeviceInfo devcieInfo,
		...
		OWDeviceManager.getInstance().owAddOfflineDevice(devcieInfo);
	...
	public void DeviceDown(String arg0, String arg1, String arg2) {
		...
		d.setGwID(arg0);
		d.setDevID(arg1);
		OWDeviceManager.getInstance().owAddOfflineDevice(d);
	}
	...
	public void DeviceData(String gwID, String devID, String devType,
		...
		OWDeviceManager.getInstance().owUpdateDeviceData(gwID,devID,devType,devEPInfo);
